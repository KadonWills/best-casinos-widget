  ...
  return (
    <Layout>
      ...
      <main className='w-screen  h-screen  grid place-items-center bg-white' >
        ...
        <code className=' fixed bottom-0 lg:bottom-3 left-3 font-mono text-blue-950 bg-cyan-300 px-2 text-base'>
          {'for Blue Window'}
        </code>
        <code className=' fixed bottom-5 lg:bottom-3 right-3 font-mono text-blue-950 text-base'>
